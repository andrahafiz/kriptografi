                                                ...
                                                <div class="row">
                                                    <div class="col">
                                                        <div class="mb-3">
                                                            ...
                                                            <input class="form-control input-air-primary" name="text" id="text" type="text" placeholder="Masukan Kata/Kalimat" min="0" style="text-transform:uppercase" onkeypress="return event.charCode < 48 || event.charCode  >57">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" class="form-control" name="cipheralphabet" id="cipheralphabet" placeholder="Masukan Alphaber dari A-Z, tidak boleh duplikat" autocomplete="on" required style="text-transform:uppercase" onkeypress="return event.charCode < 48 || event.charCode  >57">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-12 col-xl-12 text-center mt-3 mb-5">
                                                        ...
                                                        <p class="h5 txt-primary">Abjad Chiper : <small class="txt-dark"><?= $key ?></small></p>
                                                    </div>
                                                </div>
                                                <div class="row">
