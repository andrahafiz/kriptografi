    ...
    <header class="main-nav">
        <div class="sidebar-user text-center"><a class="setting-primary" href="javascript:void(0)"><i data-feather="settings"></i></a><img class="img-90 rounded-circle" src="<?= base_url() ?>assets/images/dashboard/1.png" alt="">
            <div class="badge-bottom"><span class="badge badge-primary">New</span></div><a href="user-profile.html">
                <h6 class="mt-3 f-14 f-w-600">Selamat Datang</h6>
            </a>
            <p class="mb-0 font-roboto">Para pemain kriptografi klasik</p>
        </div>
        <nav>
            <div class="main-navbar">
                ...
                <div id="mainnav">
                    <ul class="nav-menu custom-scrollbar">
                        ...
                        <li class="dropdown"><a class="nav-link menu-title link-nav" href="<?= base_url('C_DES') ?>"><i data-feather="file-text"></i><span>DES</span></a></li>
                        <li class="dropdown"><a class="nav-link menu-title link-nav" href="<?= base_url('C_3DES') ?>"><i data-feather="file-text"></i><span>3DES</span></a></li>
                        ...
                        <li class="dropdown"><a class="nav-link menu-title link-nav" href="<?= base_url('C_CaesarCipher') ?>"><i data-feather="file-text"></i><span>Caesar Chiper</span></a></li>
                        <li class="dropdown"><a class="nav-link menu-title link-nav" href="<?= base_url('C_SimpleSubCipher') ?>"><i data-feather="file-text"></i><span>Simple Substitution C</span></a></li>
                        <li class="dropdown"><a class="nav-link menu-title link-nav" href="<?= base_url('C_VigenereCipher') ?>"><i data-feather="file-text"></i><span>Vigenere Cipher</span></a></li>
